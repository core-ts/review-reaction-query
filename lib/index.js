...
var BaseCommentQuery = (function () {
  function BaseCommentQuery(repository, queryInfo) {
  ...
  BaseCommentQuery.prototype.load = function (id, ctx) {
    ...
    return this.repository.load(id, ctx).then(function (comment) {
      if (comment && _this.queryInfo) {
        return _this.queryInfo([id]).then(function (info) {
          var i = binarySearch(info, comment.userId);
          if (i >= 0) {
  ...
  BaseCommentQuery.prototype.getComments = function (id, author, limit) {
    ...
    return this.repository.getComments(id, author, limit).then(function (comments) {
      if (_this.queryInfo) {
        ...
        return _this.queryInfo(ids).then(function (info) {
...
var CommentQuery = (function (_super) {
  ...
  function CommentQuery(find, repository, queryInfo) {
    var _this = _super.call(this, repository, queryInfo) || this;
    _this.find = find;
      ...
      if (!_this.queryInfo) {
        ...
        if (res.list && res.list.length > 0) {
          ...
          return _this.queryInfo(ids).then(function (info) {
            for (var _i = 0, _a = res.list; _i < _a.length; _i++) {
              var rate = _a[_i];
              var i = binarySearch(info, rate.userId);
              if (i >= 0) {
